...
public final class DisconnectRequestBody extends AbstractMultiRawData implements RequestBody, ChannelIdAware, ControlChannelRelated {
     ...
     * @return immutable {@link DisconnectRequestBody}
     */
    public static DisconnectRequestBody valueOf(final byte[] bytes) {
     ...
     * @return immutable {@link DisconnectRequestBody}
     */
    public static DisconnectRequestBody create(final int channelId, final HPAI controlEndpoint) {
        // validate
