...
import li.pitschmann.knx.core.test.strategy.impl.DescriptionBadDataStrategy;
import li.pitschmann.knx.core.test.strategy.impl.DescriptionInvalidServiceStrategy;
