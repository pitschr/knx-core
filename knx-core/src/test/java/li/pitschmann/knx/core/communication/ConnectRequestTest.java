...
import li.pitschmann.knx.core.test.strategy.impl.ConnectBadDataStrategy;
import li.pitschmann.knx.core.test.strategy.impl.ConnectNoMoreConnectionsStrategy;
