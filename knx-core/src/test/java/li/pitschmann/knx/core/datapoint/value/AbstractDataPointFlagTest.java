...
public class AbstractDataPointFlagTest {
     ...
     * @author PITSCHR
     */
    private static class TestDataPointFlag extends AbstractDataPointFlag<BaseDataPointType<?>> {
        protected TestDataPointFlag(final BaseDataPointType<?> dpt, final byte b) {
            super(dpt, b);
        }
    }
}
