...
import li.pitschmann.knx.core.test.strategy.impl.DefaultConnectStrategy;
import li.pitschmann.knx.core.test.strategy.impl.DefaultConnectionStateStrategy;
import li.pitschmann.knx.core.test.strategy.impl.DefaultDescriptionStrategy;
import li.pitschmann.knx.core.test.strategy.impl.DefaultDisconnectStrategy;
import li.pitschmann.knx.core.test.strategy.impl.DefaultDiscoveryStrategy;
