 ...
 * @author PITSCHR
 */
public class DescriptionResponseTaskTest {

    /**
     * Tests the {@link DescriptionResponseTask#onNext(Body)}
     */
    @Test
    ...
    public void testOnNext() {
        ...
        // correct body
        final var correctBody = mock(DescriptionResponseBody.class);
    ...
    /**
     * Test the {@link DescriptionResponseTask#onError(Throwable)}
     * <p>
    ...
    /**
     * Test the {@link DescriptionResponseTask#onComplete()}
     * <p>
     * Calling this method should not throw a {@link Throwable}. It is used for logging purposes only.
     */
    @Test
    ...
    /**
     * Helper for creating a {@link DescriptionResponseTask}
     *
     * @return returns a newly instance of {@link DescriptionResponseTask}
     */
    private DescriptionResponseTask createTask() {
        final var internalClientMock = TestHelpers.mockInternalKnxClient();
        final var subscription = mock(Flow.Subscription.class);

        final var task = new DescriptionResponseTask(internalClientMock);
