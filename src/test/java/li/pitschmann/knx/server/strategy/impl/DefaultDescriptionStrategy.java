...
import li.pitschmann.knx.server.strategy.DescriptionStrategy;
...
public class DefaultDescriptionStrategy implements DescriptionStrategy {
    ...
    public MockResponse createResponse(final MockServer mockServer, final MockRequest request) {
        ...
        return new MockResponse(DescriptionResponseBody.create(deviceHardwareInformation, supportedDeviceFamilies));
    }
}
