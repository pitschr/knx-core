    ...
    public static void main(final String[] args) {
        ...
        try (DefaultKnxClient client = new DefaultKnxClient(routerAddress)) {
            ...
            for (int i = 0; i < loops; i++) {
                Sleeper.seconds(1);
//                if (i%10==0) {
//                    if (client.getStatusPool().getStatusFor(groupAddress).getApciData()[0] == 0x00) {
//                        LOG.debug("SEND ON: {}", client.writeRequest(groupAddress, DPT1.SWITCH.toValue(true)));
//                    } else {
//                        LOG.debug("SEND OFF: {}", client.writeRequest(groupAddress, DPT1.SWITCH.toValue(false)));
//                    }
//                }
