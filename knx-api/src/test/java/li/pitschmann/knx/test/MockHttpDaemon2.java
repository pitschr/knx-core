...
import li.pitschmann.knx.daemon.AbstractHttpDaemon2;
 ...
 */
public final class MockHttpDaemon2 extends AbstractHttpDaemon2 {
    private static final Logger log = LoggerFactory.getLogger(MockHttpDaemon2.class);
